...
class JustifySpec extends ObjectBehavior
{
    ...
    {
        $this->setText('piotrek piotrek kustra piotrek lorem ipsum lorem ipsum kustra piotrek lorem')->getText()->shouldReturn('piotrek piotrek kustra piotrek lorem ipsum lorem ipsum kustra piotrek lorem');
        $this->setLength(25)->getLength()->shouldReturn(25);
    }
